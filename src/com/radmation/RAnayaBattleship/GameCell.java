...
public class GameCell {
    private Boolean has_ship, placing_ship;
     ...
     * @param _bottomRight
     */
        public GameCell( Boolean _has_ship, Boolean _placing_ship, Boolean _miss, Boolean _hit, Boolean _waiting, Point _topLeft, Point _bottomRight ) {
        has_ship = _has_ship;
        placing_ship = _placing_ship;
        miss = _miss;
        hit = _hit;
        waiting = _waiting;
        topLeft = _topLeft;
     ...
     * @return has_ship
     */
    public Boolean getPlacing_ship() {return placing_ship;}
    public void setPlacing_ship(Boolean _placing_ship) {
        placing_ship = _placing_ship;
    }
