...
/**
 * Created by Radley on 11/11/2014.
 */
...
public class Preferences extends BaseActivity {
    ...
    void SetFieldsFromGamer() {
        ...
        txOnline.setText( currentUser.getOnline().toString() );
        txAvailable.setText( currentUser.getAvailable().toString() ); //used to be getAvailableDisplay();

        txGaming.setText( currentUser.getGaming().toString() );
